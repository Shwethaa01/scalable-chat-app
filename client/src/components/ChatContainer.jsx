...
export default function ChatContainer(props) {
  ...
  const getAllMessages = async () => {
    ...
    const res = await axios.post(
      ...
      {
        to: props.currentChat.contactId._id,
      },
      {
        headers: {
        ...
        <div className="chat-header">
          <div className="user-details">
            <div className="avatar">
              {props.currentChat.contactId.avatarImage ? (
                <img src={props.currentChat.contactId.avatarImage} alt="" />
              ) : (
                <IoPersonCircle />
              )}
            </div>
            <div className="username">
              <h3>{props.currentChat.contactId.username}</h3>
            </div>
          </div>
        </div>
